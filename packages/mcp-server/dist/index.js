...
import { DEFAULT_HOST, DEFAULT_PORT, HEALTH_ENDPOINT_PATH, MCP_ENDPOINT_PATH, MCP_SERVER_INFO, } from "./constants.js";
...
app.all(MCP_ENDPOINT_PATH, validateOriginHeader, requireAuthenticatedRequest, (req, res, next) => {
