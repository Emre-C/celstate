...
- **Ops investigation:** For login/generation/download incident questions, agents run `pnpm ops:investigate ...` and answer from the JSON evidence; routing lives in `docs/runbooks/OPS-INVESTIGATION.md`.
