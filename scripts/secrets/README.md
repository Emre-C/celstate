...
| Script | Purpose |
|---|---|
| `rotate.mjs` | Generate fresh values for auto-rotatable secrets (JWT keypair, Better Auth secret, Verification Runner secret, QA reset secret) and upload to Doppler. |
